    ...
    return (
        <div className="legal-page container">
            ...
            <div className="legal-content glass">
                ...
                <p>By accessing and using TechStart Platforms, you agree to be bound by these Terms of Service. If you do not agree, please do not use our services.</p>
                ...
                <p>All content, materials, and designs on the TechStart platform are the property of TechStart and protected by appropriate copyright laws.</p>
