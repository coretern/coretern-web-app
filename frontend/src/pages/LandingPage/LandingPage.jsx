...
const LandingPage = () => {
    ...
    return (
        <PageTransition>
            <SEO title="Launch Your Tech Career" description="Get hired faster with CoreTern's industry-recognized internships in Web Development, Mobile Apps, and Cloud Computing." url="/" />
