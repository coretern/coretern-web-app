...
const SEO = ({ title, description, type = 'website', url = '', image = '' }) => {
    ...
    const defaultImage = 'https://coretern.com/og-image.jpg'; // Recommended to add a real preview image link here later
    ...
    return (
        <Helmet>
            ...
            <meta property="og:url" content={`https://coretern.com${url}`} />
            ...
            <meta property="twitter:url" content={`https://coretern.com${url}`} />
