...
const SEO = ({ title, description, type = 'website', url = '', image = '' }) => {
    const siteTitle = 'TechStart | Launch Your Tech Career';
    ...
    return (
        <Helmet>
            {/* Primary Meta Tags */}
            <title>{title ? `${title} | TechStart` : siteTitle}</title>
            <meta name="title" content={title ? `${title} | TechStart` : siteTitle} />
            <meta name="description" content={description || defaultDescription} />

            {/* Open Graph / Facebook */}
            <meta property="og:type" content={type} />
            <meta property="og:url" content={`https://yourdomain.com${url}`} />
            <meta property="og:title" content={title ? `${title} | TechStart` : siteTitle} />
            ...
            <meta property="twitter:title" content={title ? `${title} | TechStart` : siteTitle} />
